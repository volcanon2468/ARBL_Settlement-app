...
import { Download, FileText, CheckCircle2, Zap, RefreshCw, BarChart3 } from 'lucide-react';
        ...
        if(bData.success && bData.data) {
           ...
           bData.data.slice(0, 192).forEach((b: any) => {
             ...
             if (b.Consumer_Label === 'TPT145') {
               grouped[key].generation_tpt = b.Revised_Gen_Allocated_KWH;
               grouped[key].consumption_tpt = b.Discom_KVAH;
             } else if (b.Consumer_Label === 'CTR2005') {
               grouped[key].generation_ctr = b.Revised_Gen_Allocated_KWH;
               grouped[key].consumption_ctr = b.Discom_KVAH;
             }
           });
      ...
      <div className="pt-8">
        <div className="flex flex-col sm:flex-row justify-between items-end mb-8 gap-4">
          ...
          <div className="flex gap-4">
            <Button variant="outline" onClick={loadResults} className="shadow-sm">Refresh Results</Button>
            <Button
